        ...
        <>
            <Wrapper>
                ...
                <div style={containerStyle}>
                    <div style={cardStyle}>
                        <h1 style={headerStyle}>Welcome {dashboarddata?.name} you are {dashboarddata?.role} </h1>
                        <img
                        ...
                        <div style={textStyle}><b>Role:</b> {dashboarddata?.role}</div>
                        <Link to="/blog" style={homeButtonStyle}>Back to Blog</Link>
                    </div>
                </div>
